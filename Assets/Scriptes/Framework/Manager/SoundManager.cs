...
public class SoundManager : MonoSingleton<SoundManager>
{
    ...
    public void PlayMusic(string name)
    {
        ...
        SourceManager.Instance.LoadMusic(name,(UnityEngine.Object obj)=>
        {
    ...
    {
        if(this.SoundVlolume<0.1f)
        {
            return;
        }
        SourceManager.Instance.LoadSound(name,(UnityEngine.Object obj)=>
        {
